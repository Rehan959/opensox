  ...
  async sendPremiumSubscriptionEmail(
    ...
    const htmlBody = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p style="color: #333; line-height: 1.8; font-size: 16px;">
          To get started, please watch this short 5 min <a href="https://youtu.be/tBY5M8WYx1M" style="color: dodgerblue">prerequisite video</a> and then book your meeting slot on Cal.
        </p>
